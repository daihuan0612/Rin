...
export function NavBar({
  ...
  const friendPageEnabled = config.getBoolean("friend_page_enable");
  ...
  return (
    <>
      ...
      <NavItem menu={menu} onClick={onClick} itemClassName={itemClassName} title={t("friends.title")} selected={location === "/friends"} href="/friends" when={friendPageEnabled} />
